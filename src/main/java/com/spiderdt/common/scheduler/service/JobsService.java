...
import com.spiderdt.common.scheduler.common.AppConstants;
import com.spiderdt.common.scheduler.common.Jdate;
import com.spiderdt.common.scheduler.common.Slog;
import com.spiderdt.common.scheduler.controller.InterfaceBean.JobInfoIn;
import com.spiderdt.common.scheduler.controller.InterfaceBean.JobListOut;
import com.spiderdt.common.scheduler.controller.InterfaceBean.JobSearchIn;
import com.spiderdt.common.scheduler.dao.AkManagerInfosDao;
import com.spiderdt.common.scheduler.dao.JobConfigurationDao;
import com.spiderdt.common.scheduler.dao.JobInfosDao;
import com.spiderdt.common.scheduler.entity.AKExecutionEntity;
import com.spiderdt.common.scheduler.entity.AkManagerInfoEntity;
import com.spiderdt.common.scheduler.entity.JobConfigurationEntity;
...
public class JobsService {
     ...
     * @throws AppException
     */
    public Integer createNewJob(JobInfoIn jobInfoIn) throws AppException {
        //校验参数
...
//        将job配置信息插入到scheduler_history_job_info表
     ...
     * @return
     */
    public Map<String, Object> getJobList(JobSearchIn params) throws AppException {
        ...
        if (params.getOrderby() == "begin_time" || params.getOrderby() == "end_time") {
            ...
            Integer all_items = 0;
            slog.info("get job list params:" + params);
            try {
     ...
     * @param job_id
     */
    public Boolean delJobByJobId(Integer job_id, String token) throws AppException {
    ...
    /**
     * 通过scheduler的job_id,查询ak中的flow对应的exec_id的执行状态
     * 同时更新到ak表中.
     *
     * @param job_id
    ...
    public Integer createDeleteJob(Integer job_id) throws AppException {
        ...
        slog.info("get job configs:" + job_configs);
//        关闭spark路径为 /data/tomcat/dmp/azkaban/test/jupiter/delete
